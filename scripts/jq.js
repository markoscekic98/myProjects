$(document).ready(function () {
        ...
        try {
            document.getElementById('moon').addEventListener('click', function (m) {
                m.preventDefault();
                $('.row2').css({
            ...
            document.getElementById('sun').addEventListener('click', function (s) {
                s.preventDefault();
                $('.row2').css({
           ...
           function filtBrend(products){
             ...
             function filtCena(products) {
                ...
                let sveCene = document.getElementById('sveCene');
                   ...
                   document.getElementById('sveCene').addEventListener('click', function (e) {
                    sveCene.checked = true;
                    ispisivanje(products); 
                    dvesta.checked = false;   trista.checked = false;  petsto.checked = false;
               });
               
             document.getElementById('200').addEventListener('click', function () {
                    // e.preventDefault();
                    filtProducts200 = products.filter(x => x.price < 200);
                    trista.checked = false;     petsto.checked = false;     sveCene.checked = false;
                ...
                document.getElementById('300').addEventListener('click', function() {
                    ...
                    dvesta.checked = false;     petsto.checked = false;     sveCene.checked = false;
                ...
                document.getElementById('500').addEventListener('click', function() {
                    ...
                    dvesta.checked = false;     trista.checked = false;     sveCene.checked = false;
